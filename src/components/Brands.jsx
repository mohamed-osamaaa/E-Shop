...
function Brands() {
    ...
    return (
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 bg-gray-200 w-full h-32 items-center justify-items-center mb-20">
            <img className='h-10 w-20 opacity-50 anim' src={br1} alt="br1" />
            <img className='h-10 w-20 opacity-50 anim' src={br2} alt="br2" />
            <img className='h-10 w-20 opacity-50 anim' src={br3} alt="br3" />
            <img className='h-10 w-20 opacity-50 anim' src={br4} alt="br4" />
            <img className='h-10 w-20 opacity-50 anim' src={br5} alt="br5" />
        </div>
    )
}
