...
function NabBar() {
    ...
    return (
        <div className="bg-white dark:bg-gray-900 dark:text-white grid justify-center grid-cols-2 gap-14 pt-7 mb-7 ml-10 mr-10">
            <div>
            ...
            <div className="flex justify-end items-center">
                <div onMouseLeave={() => setShowSearch(false)} onMouseEnter={() => setShowSearch(true)}>
                    {showSearch ? <SearchField /> : <Search className="pl-1.5 dark:text-gray-600" />}
                </div>
